...
4. *(Optional)* **Set up Weaviate for RAG workflows:**  
   If you plan to use the RAG node with a local vector store, follow the [Weaviate Setup](../weaviate-setup) guide to install and run Weaviate in Docker and configure it for Agentic Signal.  
