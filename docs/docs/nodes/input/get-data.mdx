...
![GET Data Node](/img/nodes/get-data-preview.webp)
...
<Tabs>
    <TabItem value="url" label="URL" default>
        ...
        ![AI Data Processing Node Model](/img/nodes/get-data-params.webp)
    </TabItem>
    ...
    <TabItem value="upstream" label="Upstream Input">
    ...
    <TabItem value="config-schema" label="Configuration Schema">
        <NodeSchemaTab nodeType="get-data" />
    </TabItem>
</Tabs>
